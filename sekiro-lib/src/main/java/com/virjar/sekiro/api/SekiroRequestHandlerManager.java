...
//                            break;
        ...
        Field[] fields = classFields(actionRequestHandler.getClass());
    ...
    private static Field[] classFields(Class clazz) {
        ...
        synchronized (clazz) {
            ...
            ret.addAll(Arrays.asList(classFields(clazz.getSuperclass())));
